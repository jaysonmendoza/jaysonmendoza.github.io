---
layout: post
title: Drone Frame Finite Element Analysis
description: Structural and vibration analysis of a drone frame using ANSYS Mechanical.
...
This project uses ANSYS Mechanical to analyze a drone frame under structural loading and examine its vibration behavior.

## Static Structural Analysis

Static structural analysis was used to evaluate the deformation and stress in the drone frame under applied loads.
...
Modal analysis was used to determine the natural frequencies and vibration modes of the drone frame.
